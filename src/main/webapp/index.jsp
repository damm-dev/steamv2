...
<head>
    ...
    <style>
        ...
        .btn-delete:hover {
            ...
            color: #fff !important;
            box-shadow: 0 0 10px rgba(235, 94, 85, 0.4);
        }
    </style>
</head>
<body>
